...
import { GetWorkoutDTO, GetWorkoutForUserByDateRequest } from './dto/get-workout.dto';
...
export class WorkoutService {
  ...
  async findAllByDate(request: GetWorkoutForUserByDateRequest): Promise<AppDatePagination.Response<WorkoutEntity>> {
